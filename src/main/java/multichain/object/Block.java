...
public class Block {
  ...
  public String toString() {
    return "Block [hash=" + hash + ", miner=" + miner + ", confirmations=" + confirmations
        + ", size=" + size + ", height=" + height + ", version=" + version + ", merkleroot="
        + merkleroot + ", tx=" + toStringTx() + ", time=" + time + ", nonce=" + nonce + ", bits="
