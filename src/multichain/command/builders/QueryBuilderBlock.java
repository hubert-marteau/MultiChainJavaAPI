...
public class QueryBuilderBlock extends QueryBuilderCommon {
	 ...
	 */
	protected String executeGetBestBlockHash() throws MultichainException {
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetBlock(String hashOrHeight, boolean verbose) throws MultichainException {
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetBlockCount() throws MultichainException {
	 ...
	 * @throws MultichainException
	 */
	protected String executeGetBlockHash(long index) throws MultichainException {
